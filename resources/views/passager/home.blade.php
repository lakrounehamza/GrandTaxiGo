      ...
      <div class="flex items-start">
        <div class="flex-grow truncate">
          <div class="w-full sm:flex justify-between items-center mb-3">
            <h2 class="text-2xl leading-snug font-extrabold text-gray-50 truncate mb-1 sm:mb-0">{{$trajet->name}}</h2>
          </div><span class=" px-2 py-0.5 font-semibold text-sm rounded-lg text-white">{{$trajet->email}}</span>
